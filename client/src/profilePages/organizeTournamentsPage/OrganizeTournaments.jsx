...
const OrganizeTournaments =  (props) => {
    ...
    //   },[]);
      ...
      async function getTournamnets(){
        ...
        let res = await Axios({
            url: 'http://localhost:3001/api/organizer/tournaments/1',
            method: 'get',
            timeout: 8000,
            headers: {
        ...
        return (
            <div>
                <Header />
                {tournaments.length === 0 ? <div className="alert alert-dark" role="alert" style={{marginTop: "10%"}}> No Organized Tournaments Yet !!</div>
