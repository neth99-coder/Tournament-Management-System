  ...
  return (
    <header>
      <div className="row">
        ...
        <div className="col">
          <button onClick={handleShow} className="btn-dark">
            {" "}
            <BsPlusLg />{" "}
          </button>{" "}
        </div>{" "}
          ...
          <Form noValidate validated={validated} onSubmit={handleAccept}>
            <Modal.Body>
              <div className="form-group row">
                <label for="t-name" className="col-sm-2 col-form-label">
                  {" "}
                  Event Name{" "}
                </label>{" "}
              ...
              <div className="form-group row">
                <label for="g-type" className="col-sm-2 col-form-label">
                  {" "}
                  Event Type{" "}
                </label>{" "}
                <div className="col-sm-10">
              ...
              <div className="form-group row">
                <label for="d-start" className="col-sm-2 col-form-label">
                  {" "}
                  Start Date{" "}
                </label>{" "}
                <div className="col-sm-10">
              ...
              <div className="form-group row">
                <label for="t-start" className="col-sm-2 col-form-label">
                  {" "}
                  Start Time{" "}
                </label>{" "}
                <div className="col-sm-10">
              ...
              <div className="form-group row">
                <label for="d-end" className="col-sm-2 col-form-label">
                  {" "}
                  End Date{" "}
                </label>{" "}
                <div className="col-sm-10">
              ...
              <div className="form-group row">
                <label for="t-end" className="col-sm-2 col-form-label">
                  {" "}
                  End Time{" "}
                </label>{" "}
                <div className="col-sm-10">
              ...
              <div className="form-group row">
                <label for="d-closing" className="col-sm-2 col-form-label">
                  {" "}
                  Closing Date{" "}
                </label>{" "}
                <div className="col-sm-10">
              ...
              <div className="form-group row">
                <label for="t-closing" className="col-sm-2 col-form-label">
                  {" "}
                  Closing Time{" "}
                </label>{" "}
                <div className="col-sm-10">
